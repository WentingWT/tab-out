...
- **Local shortcut icon rules** let ignored local config choose a default icon for private/internal shortcuts
- **CSP-safe image handling** avoids inline event handlers in the extension page
